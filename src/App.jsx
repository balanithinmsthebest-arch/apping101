  ...
  return (
    <>
      ...
      <div className="image-buttons">
        ...
        >
          <img src="public/images/education.png" className="logo" alt="Education" />
        </button>
        ...
        >
          <img src="public/images/acad.png" className="logo" alt="Academics" />
        </button>
        ...
        >
          <img src="public/images/tech.png" className="logo" alt="Tech" />
        </button>
        ...
        >
          <img src="public/images/club.png" className="logo" alt="Clubs" />
        </button>
        ...
        >
          <img src="public/images/interest.png" className="logo" alt="Interests" />
        </button>
        ...
        >
          <img src="public/images/contact-us.png" className="logo" alt="Contact" />
        </button>
      </div>
